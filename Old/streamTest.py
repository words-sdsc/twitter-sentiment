...
# TODO USE EXTRA PARAMS TO FIND IF QUEUE IS GROWING... CUZ INTERNET TOO SLOW
...
class listener(StreamListener):
        def on_data(self, data):
                try:
                        ...
                        print (info)
                        #time.sleep(1)
                        # FIXME Can't save into file because of the emoji thing lmao
                        #saveFile = open('info.csv','a')
                        #saveFile.write(str)
                        #saveFile.close()
